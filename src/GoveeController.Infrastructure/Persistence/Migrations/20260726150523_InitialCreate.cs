        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PowerOn = table.Column<bool>(type: "INTEGER", nullable: false),
                    Brightness = table.Column<int>(type: "INTEGER", nullable: true),
                    ColorRgbPacked = table.Column<int>(type: "INTEGER", nullable: true),
                    ColorTemperatureKelvin = table.Column<int>(type: "INTEGER", nullable: true),
